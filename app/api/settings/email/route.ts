...
// Note: profiles.email and Stripe customer email are synced in the auth callback
// after the user confirms their new email, not here (to avoid premature updates).
