    ...
    <div className="p-10 max-w-6xl">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[28px] font-display font-bold text-foreground leading-tight">Using Retirement Expert</h1>
            <p className="text-base text-text-dim mt-0.5">
              Step-by-step video guides to help you get the most out of the platform
            </p>
          </div>
        </div>
      </div>
