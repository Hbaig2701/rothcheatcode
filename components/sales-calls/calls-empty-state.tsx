...
export function CallsEmptyState({ onUpload }: CallsEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border-default bg-bg-card px-8 py-20">
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-accent mb-5">
        <Mic className="h-7 w-7 text-gold" />
      </div>
      <h3 className="text-lg font-semibold text-foreground mb-2">No sales calls yet</h3>
      <p className="text-sm text-text-dim text-center max-w-md mb-6">
