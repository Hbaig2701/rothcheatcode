      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            {totalClients === 0 && (
              <p className="text-xs text-[#6B6B6B]">No data</p>
            )}
          </div>
        </div>
        ...
        {/* Approaching RMD */}
        <div>
          <p className="text-sm text-[#A0A0A0] mb-1">Approaching RMD Age (75)</p>
