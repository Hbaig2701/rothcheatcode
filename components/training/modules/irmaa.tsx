    ...
    <div className="space-y-8">
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          ...
          Part D premiums. Anyone on Medicare with MAGI above a threshold pays it; below the
          threshold, they pay the standard premium (~$185/month for Part B in 2026).
        </p>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed">
          For an MFJ couple in 2026: crossing from Standard into Tier 1 by $1 of MAGI costs ~$1,680
          per year (combined). Crossing from Tier 1 into Tier 2: another $4,200/year. By Tier 4,
          the couple is paying over $9,000/year in extra Medicare premiums alone — for the rest of
          their lives at that income level.
        </p>
      </section>
