    ...
    <div className="space-y-8">
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          ...
          nothing&rdquo; future where they accept whatever RMDs the IRS hands them, and the
          &ldquo;Roth strategy&rdquo; future where they convert proactively at chosen brackets.
          Every chart, table, and summary number on the report exists to quantify the gap between
          those two futures and convince the client which one is worth pursuing.
        </p>
      </section>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          ...
          for this module — MFJ, 65, $1.2M IRA), the engine produced:
        </p>
        <ul className="space-y-2.5 text-base text-text-dim leading-relaxed">
          ...
          <li className="flex gap-3">
            <span className="text-gold shrink-0">·</span>
            <span>
              <strong className="text-foreground">Heir benefit</strong> — Roth dollars passed to
              heirs are tax-free; Traditional dollars are taxed at the heir&apos;s rate. The
              difference shows up here, and for high-balance clients it&apos;s often the dominant
              line in the lifetime-wealth calculation.
            </span>
          </li>
        </ul>
      </section>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          ...
          it at the <strong className="text-foreground">tax-payback age</strong>, and pulls
          steadily ahead from there.
        </p>
