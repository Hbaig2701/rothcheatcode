    ...
    <div className="space-y-8">
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          Traditional IRAs are not really &ldquo;the client&apos;s money&rdquo; in any final sense
          — they&apos;re a tax-deferral arrangement. The IRS lets the money grow without taxation
          for decades on the implicit understanding that, eventually, those dollars come out and
          get taxed at ordinary rates.
        </p>
        <p className="text-base text-text-dim leading-relaxed">
          That &ldquo;eventually&rdquo; is age 73. Under SECURE 2.0, the year your client turns
          73 (74 from 2033 onward) is the year Required Minimum Distributions begin. The IRS sets
          the amount each year using a Uniform Lifetime Table — roughly: prior year-end IRA
          balance divided by the distribution period for the client&apos;s current age.
        </p>
      </section>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed">
          That growth stacks on top of her Social Security and any other ordinary income. The
          larger the IRA at age 70, the more violently this collision happens.
        </p>
      </section>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed">
          Roth conversions exist almost entirely <em>because of</em> RMDs. The reason advisors
          push conversions in the years between retirement (often early 60s) and age 73 is to
          drain the Traditional IRA at the client&apos;s chosen brackets, before the IRS starts
          forcing distributions at whatever bracket the calendar lands them in.
        </p>
      </section>
