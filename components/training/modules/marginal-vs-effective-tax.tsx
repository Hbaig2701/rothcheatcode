    ...
    <div className="space-y-8">
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed">
          For a single filer in {new Date().getFullYear()}: the first ~$15K is the{' '}
          <Term name="standard-deduction">standard deduction</Term> (never taxed at all). The next
          ~$11K fills the 10% bracket. The next ~$35K fills the 12% bracket. The next ~$52K fills
          the 22% bracket. And so on up. Every dollar knows which bucket it landed in - no dollar
          gets taxed at a single &ldquo;your bracket&rdquo; rate.
        </p>
      </section>
      ...
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          ...
          be wrong. The <Term name="widow-penalty">widow penalty</Term> (Module 6) and{' '}
          <Term name="rmd">RMD</Term> compression (Module 4) often mean today&apos;s 24% bracket
          is cheaper than tomorrow&apos;s 32%, even if filling it feels aggressive in the moment.
        </p>
        <p className="text-base text-text-dim leading-relaxed">
