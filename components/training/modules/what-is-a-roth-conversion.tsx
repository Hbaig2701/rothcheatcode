    ...
    <div className="space-y-8">
      <section className="prose-block">
        ...
        <p className="text-base text-text-dim leading-relaxed mb-3">
          Bob has $500K sitting in his <Term name="traditional-ira">Traditional IRA</Term>. From
          the IRS&apos;s perspective, none of that money is really his yet - every dollar he
          eventually pulls out (or that gets pulled out for him via{' '}
          <Term name="rmd">Required Minimum Distributions</Term> starting at age 73) gets taxed at
          his ordinary income rate that year.
        </p>
        <p className="text-base text-text-dim leading-relaxed">
          A <strong className="text-foreground"><Term name="roth-conversion">Roth conversion</Term></strong>{' '}
          changes that. Bob transfers some amount - say $50K - from his Traditional IRA into a{' '}
          <Term name="roth-ira">Roth IRA</Term>. The IRS treats that $50K as ordinary income for
          the year of the conversion: he owes federal tax on it now. But from that moment forward,
          those dollars (and every dollar of growth they generate) are his, tax-free, forever.
        </p>
      </section>
        ...
        <ul className="space-y-2.5 text-base text-text-dim leading-relaxed">
          ...
          <li className="flex gap-3">
            ...
            <span>
              ...
              Conversions themselves don&apos;t trigger the{' '}
              <Term name="early-withdrawal-penalty">early-withdrawal penalty</Term> - but if the
