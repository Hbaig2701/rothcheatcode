...
must_haves:
  ...
  artifacts:
    - path: "supabase/migrations/YYYYMMDDHHMMSS_add_client_fields.sql"
      provides: "Migration adding 25 new columns to clients table"
...
The migration should add 25 new columns to the clients table. Current schema has:
...
<success_criteria>
- Database migration ready to add 25 new columns
