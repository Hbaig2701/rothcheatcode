...
must_haves:
  truths:
    ...
    - "Advanced section has sensitivity checkbox"
  artifacts:
    ...
    - path: "components/clients/sections/advanced.tsx"
      provides: "Advanced options form section (6 fields)"
...
6. **Sensitivity** - Checkbox, description: "Run sensitivity analysis on key assumptions"
...
Export as `AdvancedSection`.
  ...
  <verify>
    ...
    - Both checkboxes (widow_analysis and sensitivity) render correctly
  </verify>
  <done>
    - AdvancedSection renders 6 fields
    ...
    - Sensitivity checkbox works correctly
  </done>
</task>
...
- AdvancedSection has 2 percent inputs + 1 select + 1 number + 2 checkboxes
