...
export const COLUMN_DEFINITIONS: ColumnDefinition[] = [
  ...
  },
  {
    ...
    category: 'balances',
    description: 'Taxable account balance. In the baseline, this accumulates after-tax RMD proceeds. In the strategy, this tracks taxes paid from external funds (a negative value means taxes owed).',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['all'],
    defaultWidth: 150,
  ...
  // ============================================================
  {
    ...
    category: 'income',
    description: 'Annual Social Security income including COLA adjustments (2% per year). SSI is treated as tax-exempt in this model but is included in MAGI for IRMAA calculations.',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['all'],
    defaultWidth: 150,
  ...
  // ============================================================
  {
    ...
    label: 'MAGI',
    category: 'taxes',
    description: 'Modified Adjusted Gross Income. Includes AGI plus tax-exempt income and Social Security. Used to determine IRMAA Medicare surcharge tiers — a key reason to manage conversion sizes carefully.',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['all'],
    defaultWidth: 130,
  ...
  },
  {
    ...
    label: 'AGI',
    category: 'taxes',
    description: 'Adjusted Gross Income. Total income before deductions — includes conversions, RMDs, and other taxable income but not Social Security in our simplified model.',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['all'],
    defaultWidth: 120,
  ...
  // ============================================================
  {
    ...
    label: 'IRMAA Tier',
    category: 'irmaa',
    description: 'IRMAA tier based on MAGI from 2 years prior. Standard means no surcharge. Tiers 1-5 add increasing Medicare Part B and Part D premiums. Large conversions can push clients into higher tiers.',
  ...
  },
  {
    ...
    label: 'IRMAA Amount',
    category: 'irmaa',
    description: 'Annual IRMAA surcharge added to Medicare Part B and Part D premiums. Based on MAGI from 2 years ago. Applies at age 65+. Can range from $0 to over $10,000/year at the highest tier.',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['all'],
    defaultWidth: 140,
  ...
  // ============================================================
  {
    ...
    label: 'Product Bonus',
    category: 'product',
    description: 'Annual product bonus credited by the insurance carrier. Applied to the account value at the start — this is one of the key advantages of the FIA strategy over a standard IRA.',
    formatter: formatCurrency,
    defaultVisible: false,
    visibleForProducts: ['growth'],
    defaultWidth: 140,
